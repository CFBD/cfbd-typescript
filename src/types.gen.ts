...
export type AdjustedGamePreview = {
    assembledAt: string;
...
export type availability = 'pregame' | 'metadata_only';

export type AdjustedPreviewAnalysis = {
    home: AdjustedPreviewTeam;
    away: AdjustedPreviewTeam;
};

export type AdjustedPreviewTeam = {
    teamId: number;
    season: number;
    teamMetrics: PreviewSection_PreviewAdjustedTeamMetrics_;
    passing: PreviewSection_PreviewPlayerWepa_Array_;
    rushing: PreviewSection_PreviewPlayerWepa_Array_;
    kicking: PreviewSection_PreviewKickerPaar_Array_;
};
...
export type FreePreviewAnalysis = {
    ...
    series: PreviewSection_SeriesHistory_;
};

export type FreePreviewTeam = {
    teamId: number;
    season: number;
    record: PreviewSection_TeamSeasonOverview_at_record_;
    ratings: PreviewSection_TeamSeasonOverview_at_ratings_;
    statistics: PreviewSection_PreviewTeamStatistics_;
    keyPlayers: PreviewKeyPlayers;
    recentResults: PreviewSection_RecentResult_Array_;
};
...
export type GamePreviewMetadata = {
    id: number;
    season: number;
    week: number;
...
export type selection = 'active' | 'next' | 'explicit' | 'none';

export type classification = 'fbs' | 'fcs';
 ...
 */
export type Pick_KickerPAAR_Exclude_keyofKickerPAAR_attempts__ = {
    team: string;
    year: number;
    athleteId: string;
    athleteName: string;
 ...
 * From T, pick a set of properties whose keys are in the union K
 */
export type Pick_PlayerWeightedEPA_Exclude_keyofPlayerWeightedEPA_plays__ = {
    team: string;
    year: number;
    athleteId: string;
    athleteName: string;
...
export type PlayerSourceAvailability = {
...
export type status = 'available' | 'no_data' | 'unavailable';

export type reason = 'no_data' | 'source_error' | 'invalid_data';
...
export type PreviewAdjustedTeamMetrics = {
    season: number;
    isPreviousSeason: boolean;
    metrics: AdjustedTeamMetrics;
};

export type PreviewBroadcast = {
    mediaType: MediaType;
    outlet: string;
};

export type PreviewKeyPlayer = {
    athleteId: string;
    name: (string) | null;
...
export type PreviewKeyPlayers = {
    season: number;
    ppa: PlayerSourceAvailability;
    usage: PlayerSourceAvailability;
    passing: PreviewSection_PreviewKeyPlayer_Array_;
    rushing: PreviewSection_PreviewKeyPlayer_Array_;
    receiving: PreviewSection_PreviewKeyPlayer_Array_;
};

export type PreviewKickerPaar = {
    team: string;
    year: number;
    athleteId: string;
    athleteName: string;
...
export type PreviewReason = 'game_started' | 'game_completed' | 'kickoff_reached' | 'kickoff_unknown';

export type PreviewSection_PreviewAdjustedTeamMetrics_ = {
    status: 'available' | 'no_data' | 'unavailable';
    reason: ('no_data' | 'no_results_yet' | 'source_error' | 'invalid_data') | null;
    assembledAt: string;
    /**
     * Snapshot publication time, not a games-through cutoff.
     */
    sourceUpdatedAt: (string) | null;
    data: ((PreviewAdjustedTeamMetrics) | null);
};

export type reason2 = 'no_data' | 'no_results_yet' | 'source_error' | 'invalid_data';

export type PreviewSection_PreviewBroadcast_Array_ = {
    status: 'available' | 'no_data' | 'unavailable';
    reason: ('no_data' | 'no_results_yet' | 'source_error' | 'invalid_data') | null;
    assembledAt: string;
    /**
     ...
     */
    sourceUpdatedAt: (string) | null;
    data: Array<PreviewBroadcast> | null;
};

export type PreviewSection_PreviewKeyPlayer_Array_ = {
    status: 'available' | 'no_data' | 'unavailable';
    reason: ('no_data' | 'no_results_yet' | 'source_error' | 'invalid_data') | null;
    assembledAt: string;
    /**
     ...
     */
    sourceUpdatedAt: (string) | null;
    data: Array<PreviewKeyPlayer> | null;
};

export type PreviewSection_PreviewKickerPaar_Array_ = {
    status: 'available' | 'no_data' | 'unavailable';
    reason: ('no_data' | 'no_results_yet' | 'source_error' | 'invalid_data') | null;
    assembledAt: string;
    /**
     ...
     */
    sourceUpdatedAt: (string) | null;
    data: Array<PreviewKickerPaar> | null;
};

export type PreviewSection_PreviewPlayerWepa_Array_ = {
    status: 'available' | 'no_data' | 'unavailable';
    reason: ('no_data' | 'no_results_yet' | 'source_error' | 'invalid_data') | null;
    assembledAt: string;
    /**
     ...
     */
    sourceUpdatedAt: (string) | null;
    data: Array<PreviewPlayerWepa> | null;
};

export type PreviewSection_PreviewTeamStatistics_ = {
    status: 'available' | 'no_data' | 'unavailable';
    reason: ('no_data' | 'no_results_yet' | 'source_error' | 'invalid_data') | null;
    assembledAt: string;
    /**
     ...
     */
    sourceUpdatedAt: (string) | null;
    data: ((PreviewTeamStatistics) | null);
};

export type PreviewSection_RecentResult_Array_ = {
    status: 'available' | 'no_data' | 'unavailable';
    reason: ('no_data' | 'no_results_yet' | 'source_error' | 'invalid_data') | null;
    assembledAt: string;
    /**
     ...
     */
    sourceUpdatedAt: (string) | null;
    data: Array<RecentResult> | null;
};

export type PreviewSection_SelectedOdds_ = {
    status: 'available' | 'no_data' | 'unavailable';
    reason: ('no_data' | 'no_results_yet' | 'source_error' | 'invalid_data') | null;
    assembledAt: string;
    /**
     ...
     */
    sourceUpdatedAt: (string) | null;
    data: ((SelectedOdds) | null);
};

export type PreviewSection_SeriesHistory_ = {
    status: 'available' | 'no_data' | 'unavailable';
    reason: ('no_data' | 'no_results_yet' | 'source_error' | 'invalid_data') | null;
    assembledAt: string;
    /**
     ...
     */
    sourceUpdatedAt: (string) | null;
    data: ((SeriesHistory) | null);
};

export type PreviewSection_TeamSeasonOverview_at_ratings_ = {
    status: 'available' | 'no_data' | 'unavailable';
    reason: ('no_data' | 'no_results_yet' | 'source_error' | 'invalid_data') | null;
    assembledAt: string;
    /**
...
export type PreviewSection_TeamSeasonOverview_at_record_ = {
    status: 'available' | 'no_data' | 'unavailable';
    reason: ('no_data' | 'no_results_yet' | 'source_error' | 'invalid_data') | null;
    assembledAt: string;
    /**
...
export type PreviewTeamIdentity = {
    id: number;
    name: string;
    conference: (string) | null;
...
export type provider = 'DraftKings' | 'Bovada';
...
export type SeriesHistory = {
    ...
    recentMeetings: Array<SeriesMeeting>;
};
...
export type result2 = 'win' | 'tie' | 'unknown';
